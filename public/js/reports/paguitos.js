...
$(document).ready(function() {
  ...
  $('#search').on('click', function(e) {
    $('.preloader').show();
    if ($.fn.DataTable.isDataTable('#list-paguitos')) {
      $('#list-paguitos').DataTable().destroy();
    }
    $('#list-paguitos').DataTable({
      searching: true,
      processing: true,
      serverSide: true,
      ajax: {
        url: "reports/paguitos/paguitosDt",
        data: function(d) {
  ...
  $('#download').on('click', function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "reports/paguitos/download-report",
      data: data,
      dataType: "text",
