...
class ClientNetweyBackup extends Model {
    protected $table = 'islim_client_netweys_backup';
    ...
    public static function getReport($services = [], $status = null, $date_ini = null, $date_end = null, $msisdns = null) {
        $report = DB::table('islim_client_netweys')
                    ->select(
                    ...
                    ->join('Islim_broadbands', 'Islim_broadbands.broadband', '=', 'islim_services.broadband')
