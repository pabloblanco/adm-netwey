...
class KPIReportMIFIH extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:kpiMIFIH';
     ...
     * @var string
     */
    protected $description = 'Ejecuta cron para calcular kpis version 2.0 de MIFI Huella Altan';
    ...
    {
        $lastMetrcis = MetricsBi2::getLastMetric('MH');
        ...
        $contRec = HistoryDC2::getClientsByTag(['REC'], 'MH')->get()->count();
