  ...
  <div class="container-fluid">
    <div class="row bg-title">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h4 class="page-title">Gestión de comisiones de
          @if (session('user')->platform == 'admin') coordinadores @else vendedores @endif</h4>
      </div>
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          <li><a href="/islim/">Dashboard</a></li>
          <li class="active">Gestión de comisiones</li>
        </ol>
      </div>
    </div>
    <div class="row">
...
@else
  ...
  @endif
@endif
<script src="js/seller/comission/main.js"></script>