<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Churn (Churn90)</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Reportes BI</a></li>
                <li class="active">Churn</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="row m-t-40">
        <div class="col-md-4 col-xs-12">
            <div class="white-box">
                <h3 class="box-title"> Churn Parque recargador (mm/aaaa) <span class="date-total">({{date('m/Y', $time)}})</span></h3>
                <ul class="list-inline two-part">
                    <li><i class="icon-people text-success"></i></li>
                    <li class="text-right"><span class="counter" id="totalClientsCP" style="font-size: 32px;">0</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="white-box">
                <h3 class="box-title"> Churn Bruto (mm/aaaa) <span class="date-total">({{date('m/Y', $time)}})</span></h3>
                <ul class="list-inline two-part">
                    <li><i class="icon-people text-success"></i></li>
                    <li class="text-right"><span class="counter" id="totalClientsCB" style="font-size: 32px;">0</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="white-box">
                <h3 class="box-title"> Churn Neto (mm/aaaa) <span class="date-total">({{date('m/Y', $time)}})</span></h3>
                <ul class="list-inline two-part">
                    <li><i class="icon-people text-success"></i></li>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="white-box">
                <h3 class="box-title"> Procentaje Churn (mm/aaaa) <span class="date-total">({{date('m/Y', $time)}}) </h3>
                <ul class="list-inline two-part">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-center">
                    Churn90 parque recargador {{-- hasta el <b>{{date('m/Y', $time)}}</b> --}}
                </h3>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        getMetric = function(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $('#totalClientsCP').text(response.totalCP);
                    $('#totalClientsCB').text(response.totalCB);
        ...
        $('#download').on('click', function(){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('downloadClientsChurn')}}",
                data: data,
                dataType: "json",
                success: function(response){
                    $(".preloader").fadeOut();
