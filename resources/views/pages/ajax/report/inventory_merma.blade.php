...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Reporte de inventario en bodegas merma</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Reporte</a></li>
                <li class="active">inventario en bodegas merma</li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <select id="warehouse" name="warehouse" class="form-control">
                            ...
                            <option value="MT">Merma - robados</option>
                            <option value="MO">Merma - equipos viejos</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="row white-box">
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="list-inv" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>MSISDN</th>
                                    <th>Art&iacute;culo</th>
                                    <th>Usuario que tenia el art&iacute;culo</th>
                                    <th>Usuario que movio el art&iacute;culo</th>
                                    <th>Bodega</th>
                                    <th>Fecha</th>
                                </tr>
                            </thead>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#search').on('click', function(e){
            ...
            if ($.fn.DataTable.isDataTable('#list-inv')){
                $('#list-inv').DataTable().destroy();
            }
            ...
            $('#list-inv').DataTable({
                ...
                order: [[ 5, "desc" ]],
                columns: [
                    {data: 'msisdn', orderable: false, searchable: false},
                    {data: 'title', searchable: false, orderable: false},
                    {data: 'origin_name', searchable: false, orderable: false},
                    {data: 'assigned_name', searchable: false},
        ...
        $('#download').on('click', function(e){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('downloadgetInventoryMermaDt')}}",
                data: data,
                dataType: "text",
