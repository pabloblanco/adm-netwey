...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Instalaciones de fibra</h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <label class="control-label">Fecha preventa desde</label>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <label class="control-label">Fecha preventa hasta</label>
                        <div class="input-group">
                        ...
                        <table id="list-com" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Venderdor</th>
                                    <th>Instalador</th>
                                    <th>Teléfono del Instalador</th>
                                    <th>Zona de Cobertura</th>
                                    <th>Fecha de PreVenta</th>
                                    <th>Fecha de Instalación</th>
                                    <th>Cobrado</th>
                                    <th>Estado Actual</th>
                                    <th>Re-programaciones</th>
                                    <th>Razon Eliminacion</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
<script src="js/reports/fiberInstallation.js"></script>