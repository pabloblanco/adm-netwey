<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Art&iacute;culos activos</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Reportes</a></li>
                <li class="active">Art&iacute;culos activos</li>
            </ol>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-center">
                        Art&iacute;culos vendidos activos
                    </h3>
                        ...
                        <table id="tablebt" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Tel&eacute;fono contacto 2</th>
                                    <th>Email</th>
                                    <th>MSISDN</th>
        ...
        drawTable = function(){
            ...
            var tableClients = $('#tablebt').DataTable({
                ...
                columns: [
                    ...
                    {data: 'date_act',searchable: false}
                ]
            });
        }
