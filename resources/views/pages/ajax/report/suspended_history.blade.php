...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Reporte Histórico de Suspensiones</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Reporte</a></li>
                <li class="active">Histórico de Suspensiones</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <label class="control-label">Tipo de Suspensión</label>
                        <select id="typesuspended" name="typesuspended" class="form-control">
                            <option value="">Seleccione un tipo</option>
                            <option value="mobility">Por Movilidad</option>
                            <option value="theftorloss">Por Robo o Extravío</option>
                            <option value="inactive">Por Inactividad</option>
                            <option value="imeilock">Por Imei Bloqueado</option>
                            <option value="callcenter">Por Call Center</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="row white-box">
                <div class="col-md-12">
                    <h3 class="text-center">
                        Reporte Histórico de Suspensiones
                    </h3>
                </div>
    ...
    $(document).ready(function () {
        ...
        $('#search').on('click', function(e){
            ...
            $('#list-com').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{route('getDTSuspendedHistory')}}",
                    data: function (d) {
                        d._token = $('meta[name="csrf-token"]').attr('content');
                        d.dateb = $('#dateb').val();
                        d.datee = $('#datee').val();
                        d.msisdn = $('#msisdn').val();
                        d.typesuspended = $('#typesuspended').val();
                    },
                ...
                columns: [
                    ...
                    {data: 'typesuspended', searchable: false, orderable: false},
        ...
        $('#download').on('click', function(e){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('downloadDTSuspendedHistory')}}",
                data: data,
                dataType: "text",
