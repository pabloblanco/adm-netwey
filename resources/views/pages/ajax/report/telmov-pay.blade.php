...
<div class="container-fluid">
  <div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h4 class="page-title">
        Reporte de financiamientos TelmovPay
      </h4>
    </div>
      ...
      <div class="row white-box">
        <div class="col-md-12">
          <h3 class="text-center">
            Reporte de Financiamientos con TelmovPay
          </h3>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
          <div class="table-responsive">
            <table class="table table-striped display nowrap" id="list-telmov-pay">
              <thead>
                <tr>
                  <th>
                    MSISDN
...
<script src="js/reports/telmovPay.js">
</script>
