<div class="row">
	<div class="col-md-4 col-xs-12 col-sm-12">
        <div class="white-box text-center bg-theme-dark">
            <h1 class="text-white">
            	$
            	<span class="counter">
            		{{number_format($data->total_mount_e, 2, '.', ',')}}
            	<span>
            </h1>
            <p class="text-white font-18">Monto Efectivo</p>
        </div>
    </div>
    ...
    <div class="col-md-4 col-xs-12 col-sm-12">
        <div class="white-box text-center bg-theme-dark">
            <h1 class="text-white">
            	$
            	<span class="counter">
            		{{number_format(($data->due + $data->total_mount_e), 2, '.', ',')}}
            	<span>
            </h1>
            <p class="text-white font-18">Monto Deuda</p>
        </div>
    </div>
    ...
    <div class="col-md-4 col-xs-12 col-sm-12">
        <div class="white-box text-center bg-theme-dark">
            ...
            <p class="text-white font-18">Ventas/mes</p>
        </div>
    </div>
</div>
	...
	<div class="col-md-12">
		@if (isset($inventories['inventory']))
			...
			<div class="table-responsive">
	            <table id="myTableInventory" class="table table-striped">
					<thead>
						<tr>
							<th>Marca</th>
							<th>IMEI</th>
...
@endif
<script src="js/reports/usersDetailReport.js"></script>