...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Reporte Ventas con Coppel</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Reporte</a></li>
                <li class="active">Ventas con Coppel</li>
            </ol>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#search').on('click', function(e){
            ...
            $('#list-com').DataTable({
                ...
                columns: [
                    ...
                    {data: 'seller_name', searchable: false, orderable: false},
                    {data: 'client_name', searchable: false, orderable: false},
                    {data: 'client_phone', searchable: false, orderable: false},
        ...
        $('#download').on('click', function(e){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('downloadDTCoppelSales')}}",
                data: data,
                dataType: "text",
