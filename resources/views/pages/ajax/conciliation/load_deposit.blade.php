<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Conciliaci&oacute;n de dep&oacute;sitos @if($status != 'A') (Usuarios Eliminados) @endif</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Vendedores</a></li>
                <li class="active">Conciliaci&oacute;n de dep&oacute;sitos efectivo</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-center p-b-20">
                    Carga de dep&oacute;sitos
                </h3>
                <form id="formDepositFile" name="formDepositFile" class="form-inline" action="{{ route('load_deposit_file') }}">
                    <div class="form-group p-r-20">
                        <select id="bank" name="bank" class="form-control" placeholder="Seleccione un Coordinador" data-msg="Debe seleccionar un usuario." required>
                    ...
                    <div class="form-group">
                        <button class="btn btn-success" id="loadDep" type="button">
                            Cargar CSV
                        </button>
                    </div>

                    <input type="file" name="deposits" id="deposits" hidden>
                </form>
            </div>

            <div class="col-md-12" id="pending-content" hidden="true">
                <h3>Dep&oacute;sitos sin asignar</h3>
                <div class="table-responsive">
                    <table id="list-na" class="table table-striped">
                        <thead>
                            <tr>
                                <th>Opciones</th>
                                <th>Banco</th>
            ...
            <div class="col-md-12" id="asigned-content" hidden="true">
                <h3>Dep&oacute;sitos asignados el {{ date('d-m-Y H:i') }}</h3>
                <div class="table-responsive">
                    <table id="list-da" class="table table-striped">
                        <thead>
                            <tr>
                                <th>C&oacute;digo de dep&oacute;sito</th>
                                <th>Usuario</th>
                                <th>Monto</th>
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                <h3 class="text-center p-b-20">
                    Usuarios @if($status != 'A') Eliminados @endif con deuda por conciliar
                </h3>
...
<script type="text/javascript">
    ...
    userStatus = () => {return '{{ $status }}';};
</script>

<script src="js/loaddeposit/main.js?{{time()}}" defer="defer"></script>
