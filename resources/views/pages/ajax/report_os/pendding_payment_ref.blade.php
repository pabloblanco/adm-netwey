<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Referencias de Pago en Efectivo Pendientes/Canceladas</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Reportes Ventas Online</a></li>
                <li class="active">Referencias de Pago en Efectivo Pendientes/Canceladas</li>
            </ol>
        </div>
    </div>
</div>
            ...
            <div class="row white-box">
                <div class="col-md-12">
                    <h3 class="text-center">
                        Referencias de Pago en Efectivo Pendientes/Canceladas
                    </h3>
    ...
    $(document).ready(function (){
        ...
        drawTable = function(){
            ...
            var tableClients = $('#tablebt').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{route('getPenddingPaymentRefForReportOS')}}",
                    data: function (d) {
                        d.date_ini = date_ini;
                        d.date_end = date_end;                   
                ...
                columns: [
                    ...
                    {data: 'Equipo',searchable: false},                    
                    {data: 'Metodo',searchable: false},                    
        ...
        $('#download').on('click', function(){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('downloadPenddingPaymentRefForReportOS')}}",
                data: data,
                dataType: "json",
